# 更新日志
### 2026-05-15
- `huawei_cn` 新增 华为超新星手表 X1 系列。
### 2026-05-14
- `honor_cn` 新增 荣耀 600 系列、荣耀平板 20。
- `lenovo_cn` 新增 拯救者手机 Y70 新一代、平板 Y900 系列。
### 2026-05-10
- `huawei_cn` 新增 华为智慧屏 S7。
### 2026-05-09
- `vivo_cn` 新增 iQOO 15T。
### 2026-05-07
- `oneplus` 新增 一加 Nord CE6 系列。
### 2026-05-06
- `oneplus` 新增 OnePlus Pad 4（国际版）。
### 2026-05-02
- `zte_cn` 新增 中兴云电脑 逍遥系列。
### 2026-05-01
- `zhixuan` 增补 WIKO 产品代号。
### 2026-04-28
...
### 2026-04-03
- `mitv_cn` 新增 小米电视 S Mini LED 2026。
### 2026-04-02
- `honor_cn` 新增 荣耀畅玩 80。
### 2026-04-01
...
### 2026-03-23
- `huawei_cn` 新增 HUAWEI Mate 80 Pro Max 风驰版、华为畅享 90 系列。
### 2026-03-22
- `mitv_cn` 新增 REDMI 电视 A Pro 2026 系列。
### 2026-03-19
- `vivo_cn` 新增 vivo X300 Ultra/X300s、iQOO Z11 系列。
### 2026-03-18
- `lenovo_cn` 新增 Y700 五代、小新 Pro 13 系列。
- `oneplus` 新增 一加 15T。
### 2026-03-17
...
### 2026-03-11
- `huawei_cn` 新增 华为 Vision 智慧屏 6 系列。
### 2026-03-10
- `honor_cn` 新增 荣耀 Magic V6。
### 2026-03-09
...
### 2026-02-24
- `honor_cn` 新增 荣耀平板 X10。
### 2026-02-12
- `honor_cn` 增补 荣耀平板 Z6 第二代。
### 2026-02-10
...
### 2026-01-07
- `motorola_cn` 新增 moto X70 Air Pro。
### 2026-01-05
...
### 2025-04-16
- `honor_cn` 新增 荣耀平板 GT、荣耀 X60 GT、荣耀手环 10。
### 2025-04-15
...
### 2025-02-05
- `realme_cn` 新增 真我 GT7 Pro 竞速版、真我 Neo7 SE。
### 2025-01-27
- `samsung_cn` 新增 Galaxy S25 系列。
### 2025-01-22
- `vivo_cn` 新增 Y300i, Y300t, iQOO Z10x。
### 2025-01-21
- `realme_cn` 新增 真我 14 Pro。
- `samsung_cn` 新增 Galaxy A56 5G。
### 2025-01-20
- `huawei_cn` 增补 华为智慧屏 S5 New、Vision 4 New。
### 2025-01-16
- `oneplus` 新增 一加 13 系列海外版。
### 2025-01-13
- `xiaomi-wear` 增补部分海外型号，新增小米 TWS 耳机型号。
### 2025-01-11
- `xiaomi` 新增 Redmi Note 14 国际版。
### 2025-01-09
- `realme_cn` 新增 真我 14 Pro+。
### 2025-01-01
- `honor_cn` 新增 荣耀笔记本 X14 2025。
### 2024-12-30
- `honor_cn` 新增 荣耀平板 X9 Pro。
### 2024-12-28
- `huawei_cn` 新增 华为畅享 70X。
### 2024-12-27
...
- `honor_cn` 新增 荣耀平板 V9。
### 2024-12-15
- `zhixuan` 新增 Hi MatePad。
### 2024-12-09
- `coolpad` 新增 酷派 Y77。
### 2024-12-04
- `zte` 新增 中兴小鲜 60 臻情版。
### 2024-12-02
- `honor_cn` 新增 荣耀笔记本 X Plus 2025。
### 2024-11-27
- `nubia` 新增部分海外型号。
...
- `zte` 新增 中兴 V70。
### 2023-06-01
- `motorola` 新增 moto razr 40 系列。
### 2023-05-31
- `vivo_cn` 新增 vivo S17t。
### 2023-05-29
- `xiaomi` 新增 Redmi Note 12T Pro。
### 2023-05-23
- `mitv_cn` 新增 小米电视 S85。
### 2023-05-22
...
### 2023-05-18
- `honor_cn` 新增 荣耀穿戴设备型号。
- `huawei_cn` 新增 华为新品, 华为穿戴设备型号。
- `oneplus` 新增 OnePlus Nord 3。
### 2023-05-17
- `honor_cn` 新增 荣耀 90 系列, 荣耀畅玩 40。
### 2023-05-16
- `coolpad` 新增 酷派 COOL 30 Pro。
### 2023-05-15
- `xiaomi` 增补部分设备内部名称。
### 2023-05-11
- `sony_cn` 新增 Xperia 1 V。
### 2023-05-08
- `huawei_cn` 新增部分商用型号。
### 2023-05-07
- `vivo_cn` 新增 X90S, S17 系列, Y35+, iQOO Neo8 系列。
### 2023-05-03
- `honor_cn` 新增 荣耀平板 V8。
- `huawei_cn` 更新部分代号。
- `mitv_cn` 新增部分型号。
...
### 2022-12-02
- `360shouji` 新增 奇少年 Q20。
### 2022-11-29
- `xiaomi` 新增 Xiaomi 13 系列。
### 2022-11-23
- `honor_cn` 新增 荣耀 Magic Vs & 荣耀 80 系列。
### 2022-11-18
- `vivo` 新增 vivo X90 系列。
### 2022-11-14
...
- `honor_cn` 增补 部分笔记本型号。
### 2022-11-02
- `huawei_cn` 新增 华为智慧屏 V 三代。
### 2022-11-01
- `honor_cn` 新增 荣耀畅玩 30M。
- `oppo_cn` 新增 OPPO A58。
### 2022-10-27
...
- `nokia` 新增 Nokia C31。
### 2022-10-13
- `honor_cn` 新增 荣耀 X40 GT & 荣耀畅玩 40 Plus。
### 2022-10-11
- `huawei_cn` 增补 Mate 50 系列代号。
### 2022-10-08
- `honor_cn` 新增 荣耀 Play6C。
### 2022-10-06
- `honor_cn` 新增 荣耀畅玩 20a。
### 2022-10-04
- `xiaomi` 新增 Redmi Note 11R & Redmi Pad。
### 2022-10-01
- `mitv_cn` 新增 Redmi 电视 XT 系列。
### 2022-09-29
- `huawei_cn` 新增 华为 Vision 智慧屏系列。
### 2022-09-28
- `vivo` 新增 vivo Y73t。
### 2022-09-26
- `zhixuan` 新增 麦芒 · 十年臻爱版。
- `zte` 新增 中兴 Axon 30S。
### 2022-09-21
- `360shouji` 新增 360OS 奇少年 Q20 Pro。
### 2022-09-20
...
### 2022-02-12
- `samsung_cn` 新增 Galaxy S22 & Tab S8 系列 国行版。
### 2022-02-09
- `xiaomi` 新增 Redmi K50 电竞版。
### 2022-02-08
- `honor_cn` 新增 荣耀 60 SE。
### 2022-01-26
- `xiaomi` 新增 Redmi Note 11 系列海外版。
### 2022-01-24
- `zhixuan` 新增 华为智选手机型号汇总。
### 2022-01-19
- `xiaomi` 新增 Xiaomi 11T Pro 印度版。
### 2022-01-14
...
### 2021-12-09
- `xiaomi` 新增 Xiaomi 11 青春活力版。
### 2021-12-08
- `360shouji` 新增 360OS 奇少年手机。
### 2021-12-07
- `mitv_cn` 新增 小米电视 ES50 2022 款。
### 2021-12-06
- `vivo` 新增 vivo Y32 & Y55s。
### 2021-12-01
- `honor_cn` 新增 荣耀 60 系列。
- `motorola` 新增 摩托罗拉 edge X30 & S30。
### 2021-11-28
- `nokia` 新增 Nokia T20。
### 2021-11-25
- `honor_cn` 新增 荣耀智慧屏 X2 43 英寸。
- `huawei_cn` 新增 HUAWEI nova 8 SE 4G & 华为擎云 L410。
- `oppo_cn` 新增 OPPO Reno7 系列。
...
- `vivo` 新增 vivo Y54s。
### 2021-11-17
- `huawei_cn` 新增 HUAWEI Mate X2 典藏版 & HUAWEI MateBook E (2021)。
### 2021-11-10
- `vivo` 新增 vivo Y76s。
### 2021-11-09
- `realme_cn` 新增 真我 Q3t。
### 2021-11-08
- `vivo` 新增 vivo Y31s (t2 版)。
### 2021-11-02
- `xiaomi` 新增部分海外型号。
### 2021-10-28
- `honor_cn` 新增 荣耀 X30i。
...
- `huawei_cn` 增补部分代号信息。
### 2021-10-01
- `xiaomi` 新增 Redmi Note 10 Lite 印度版。
### 2021-09-30
- `xiaomi` 新增 POCO C31。
### 2021-09-28
- `xiaomi` 增补印度版 Redmi 9 系列。
### 2021-09-27
...
- `huawei_cn` 增补部分华为智慧屏型号。
- `meizu` 新增 魅族 18X & 18s 系列。
### 2021-09-09
- `vivo` 新增 vivo X70 系列 & vivo S10e。
### 2021-09-03
- `xiaomi` 新增 Redmi 10 Prime 印度版。
### 2021-09-02
- `realme` 增补部分国际型号。
### 2021-08-24
...
### 2021-07-29
- `huawei` 新增 HUAWEI P50 系列。
### 2021-07-27
- `zte` 新增中兴 Axon 30。
### 2021-07-26
- `huawei` 新增 HUAWEI nova 8 SE 活力版。
### 2021-07-22
- `vivo` 新增 vivo Y53s (t1 版)。
### 2021-07-21
- `realme` 新增真我 GT 大师系列。
### 2021-07-19
...
- `honor` 新增荣耀 X20 SE。
### 2021-06-28
- `mitv` 新增小米电视 ES 2022 款、小米电视 6 至尊版。
### 2021-06-26
- `oppo` 新增 OPPO A93s。
### 2021-06-21
- `zte` 增补部分型号。
...
- `vivo` 新增 vivo Y53s。
### 2021-06-07
- `vivo` 新增 vivo X60t Pro+。
### 2021-06-06
- `vivo` 新增 iQOO U3x 标准版。
### 2021-06-03
- `honor` 增补个别遗漏型号。
...
### 2021-05-25
- `huawei` 新增华为部分手机 4G 版本。
- `realme` 新增真我 Q3 Pro 狂欢版、真我 GT Neo 闪速版；增补部分国际型号。
### 2021-05-23
- `apple` 新增 iPad Pro (2021)。
### 2021-05-22
- `vivo` 新增 vivo X60 曲屏版、vivo Y70t。
### 2021-05-21
- `nubia` 新增红魔 6R。
- `realme` 增补部分国际型号。
### 2021-05-20
- `oppo` 新增 OPPO Reno6 系列。
### 2021-05-19
- `huawei` 新增华为部分新品。
### 2021-05-18
- `honor` 新增荣耀 Play5。
...
- `honor` 增补部分产品信息。
### 2021-05-02
- `vivo` 新增 vivo Y52s (t1 版)。
### 2021-04-27
- `xiaomi` 新增 Redmi K40 游戏增强版。
### 2021-04-26
- `honor` 新增荣耀畅玩 20。
### 2021-04-25
- `motorola` 新增 motorola g50。
### 2021-04-21
- `oppo` 新增 OPPO K9。
### 2021-04-20
- `honor` 新增荣耀 Play5T 活力版。
- `vivo` 新增 vivo Y30 活力版。
### 2021-04-17
- `oneplus` 更新 OnePlus 9R 代号信息。
- `realme` 增补部分国际型号，新增 realme 真我 Q3 系列。
### 2021-04-16
- `mitv` 新增小米电视 EA 2022；将国际型号单独汇总。
- `oppo` 新增 OPPO A95。
### 2021-04-15
- `zte` 新增中兴 Axon 30 系列。
### 2021-04-12
- `realme` 订正部分国内型号。
- `xiaomi` 新增部分 Redmi Note 10 系列型号。
### 2021-04-09
...
- `huawei` 增补华为智慧屏代号信息。
### 2021-03-17
- `samsung` 新增三星 Galaxy A52 5G。
### 2021-03-16
- `vivo` 新增 iQOO Neo5。
### 2021-03-15
- `oneplus` 更新 Nord 系列区域信息。
- `xiaomi` 订正部分信息。
### 2021-03-11
...
### 2021-02-05
- `realme` 新增 realme 真我 V11。
### 2021-02-02
- `realme` 增补部分产品型号。
- `xiaomi` 更新 Redmi 部分产品国际型号。
### 2021-01-29
- `vivo` 新增 vivo S7t。
### 2021-01-26
...
- `oppo` 更新部分产品型号。
### 2020-07-02
- `honor` 新增荣耀平板 V6 5G 版。
- `mitv` 新增小米电视大师 65 英寸。
### 2020-07-01
- `xiaomi` 新增 Redmi 9A 国际版。
### 2020-06-29
- `honor` 新增荣耀 30 青春版。
### 2020-06-27
- `realme` 更新部分国际产品型号。
### 2020-06-23
- `honor` 新增荣耀 X10 Max，更新部分产品型号。
- `huawei` 更新部分产品型号。
### 2020-06-20
- `xiaomi` 更正 Redmi 9 代号。
### 2020-06-19
- `huawei` 更新部分产品代号。
### 2020-06-16
- `huawei` 新增华为畅享 20 Pro。
### 2020-06-14
- `vivo` 新增 vivo X50 Pro+。
### 2020-06-12
- `xiaomi` 更新部分产品型号。
### 2020-06-10
- `xiaomi` 新增 Redmi 9 国际版。
### 2020-06-08
- `realme` 新增 realme X50t。
### 2020-06-05
- `mitv` 更新部分国际型号。
- `oppo` 新增 OPPO Reno4 系列。
### 2020-06-02
- `honor` 新增荣耀 Play 4 系列。
### 2020-06-01
- `vivo` 新增 vivo X50 系列。
### 2020-05-26
- `mitv` 新增 Redmi 智能电视 X 系列。
- `xiaomi` 新增 Redmi 10X 系列。
### 2020-05-25
- `mitv` 新增小米全面屏电视 E43K、E32S。
- `realme` 新增 realme X3 超级变焦版。
### 2020-05-24
- `huawei` 新增华为畅享 Z 5G。
### 2020-05-20
- `honor` 新增荣耀 X10。
...
### 2020-05-18
- `honor` 新增荣耀平板 V6、荣耀智慧屏 X1、荣耀 MagicBook Pro 2020。
### 2020-05-15
- `realme` 新增 realme X50 Pro 玩家版。
### 2020-05-12
- `realme` 新增部分国际机型。
### 2020-05-11
...
### 2020-04-03
- `mitv` 新增小米电视 4A 60 英寸、小米全面屏电视 Pro E75S。
- `xiaomi` 新增小米 10 Lite 国际版、Redmi 8A Pro 国际版。
### 2020-03-31
- `vivo` 新增 vivo S6。
### 2020-03-30
- `honor` 新增荣耀 30S、荣耀畅玩 9A。
### 2020-03-28
- `huawei` 新增 HUAWEI P40 Pro+。
### 2020-03-27
- `mitv` 新增小米电视国际版 Mi TV 4S 65。
### 2020-03-26
- `huawei` 新增 HUAWEI P40 系列、HUAWEI nova 5i 联通定制版。
### 2020-03-25
...
### 2020-03-05
- `realme` 新增 realme 6 系列。
### 2020-03-03
- `vivo` 新增 vivo NEX 3S 5G。
- `xiaomi` 新增腾讯黑鲨游戏手机 3 系列；订正部分信息。
### 2020-03-01
- `huawei` 新增华为畅享 10e。
### 2020-02-25
...
- `mitv` 新增小米电视 5 系列。
### 2019-11-04
- `全局` 新增 `misc` 文件夹，内含部分因故未能收录的内容。
- `vivo` 新增 vivo Y5s。
### 2019-11-02
- `oppo` 更正 OPPO A11 型号。
### 2019-11-01
- `mitv` 新增 Redmi 红米电视 40 英寸 R40A。
...
- `xiaomi` 订正部分信息。
### 2019-10-22
- `honor` 更新荣耀平板 5 8 英寸版型号。
- `huawei` 更新华为平板 M5 青春版 8 英寸版型号。
- `vivo` 新增 vivo Y3 标准版。
### 2019-10-21
...
- `honor` 更新荣耀 9X 代号。
### 2019-09-29
- `mitv` 新增小米电视 4S 70 英寸、小米全面屏电视 E43X、小米全面屏电视 E65C。
### 2019-09-27
- `huawei` 订正部分信息。
...
### 2019-09-19
- `honor` 更新荣耀 20 系列代号。
- `huawei` 新增 HUAWEI Mate 30 系列。
### 2019-09-18
- `mitv` 新增小米电视 4A 70 英寸。
### 2019-09-17
- `honor` 新增荣耀 Play 3e。
...
### 2019-08-15
- `huawei` 华为平板 C3 (华为平板 T3 行业专享版) 宣传名变更。
### 2019-08-13
- `meizu` 新增魅族 16s Pro。
### 2019-08-08
- `vivo` 更正 vivo Z5x 移动全网通版型号。
### 2019-08-05
- `honor` 新增部分产品代号。
### 2019-07-30
- `smartisan` 更新坚果手机代号。
...
- `vivo` 新增产品 codename。
### 2019-07-11
- `huawei` 新增 HUAWEI 麦芒 8 部分型号。
### 2019-07-04
- `honor` 整理产品系列。
- `mitv` 新增小米全面屏电视 E32C、E40A。
- `motorola` 新增 motorola p50。
- `xiaomi` 更新小米 CC9 系列代号。
### 2019-07-03
- `全局` 文档版停止维护，此仓库 markdown 版本**不受影响**。
- `vivo` 更新 iQOO Neo 移动全网通版。
### 2019-07-02
- `xiaomi` 新增小米 CC9、小米 CC9e。
### 2019-06-30
- `xiaomi` 新增小米 9T Pro 国际版。
### 2019-06-28
- `honor` 新增部分产品代号。
- `huawei` 新增部分产品代号。
- `mitv` 新增小米电视 4A 43 英寸 SE、50 英寸 SE、小米电视 4C 40 英寸 SE。
### 2019-06-25
- `huawei` 新增 HUAWEI Mate 20 X 5G 版。
### 2019-06-21
- `huawei` 新增 HUAWEI nova 5 系列、华为平板 M6 系列。
### 2019-06-20
- `vivo` 新增 iQOO Neo。
### 2019-06-19
- `lenovo` 新增联想 Z6。
...
- `meizu` 新增魅族 16Xs 国际版。
### 2019-06-15
- `mitv` 新增小米电视 55 英寸全面屏 PRO、小米电视 65 英寸全面屏 PRO。
### 2019-06-13
- `xiaomi` 新增小米 9T 国际版。
- `xiaomi` 更正小米 8 屏幕指纹版的编号。
### 2019-06-12
- `apple` 整理 iPad 分类。
...
- `huawei` 更新华为畅享 9e 代号。
### 2019-04-10
- `oppo` 新增 OPPO Reno 系列。
### 2019-04-09
- `honor` 新增荣耀 20i。
- `motorola` 新增 motorola g7 plus。
### 2019-04-08
- `nokia` 新增 Nokia X71。
### 2019-04-03
- `oppo` 新增 OPPO A7n。
### 2019-03-28
- `meizu` 新增国际机型、机型代号。
- `xiaomi` 更正 Redmi 7 codename。
### 2019-03-27
- `vivo` 新增 vivo S1、vivo Y91。
### 2019-03-26
- `apple` 更新产品代号。
- `huawei` 新增 HUAWEI P30 系列。
- `nokia` 新增 Nokia 9 PureView。
### 2019-03-25
- `huawei` 新增华为畅享 9S、华为畅享 9e、华为平板 M5 青春版 8 英寸。
- `samsung` 更新 Galaxy S10 系列移动定制版型号。
- `xiaomi` 新增小米 9 SE 国际版本。
### 2019-03-20
- `xiaomi` 新增 Redmi 7 国际版本。
### 2019-03-19
- `vivo` 新增 vivo X27、vivo X27 Pro。
### 2019-03-18
- `apple` 新增 iPad Air (第 3 代)、iPad mini (第 5 代)。
### 2019-03-14
- `huawei` 新增 HUAWEI nova 4e。
- `oppo` 新增 OPPO A5 部分型号。
- `xiaomi` 新增 Redmi 7、黑鲨 2 等即将发布的机型，更新产品代号。
### 2019-03-07
- `xiaomi` 新增小米 9 联通电信定制版。
### 2019-03-06
- `meizu` 新增魅族 Note9。
### 2019-03-05
- `honor` 新增荣耀平板 5 8 英寸版。
### 2019-03-01
- `vivo` 新增 iQOO。
### 2019-02-28
- `mitv` 新增部分小米电视印度型号。
...
- `xiaomi` 调整了部分细节。
- `xiaomi` 移除了个别从未上市过的型号。
### 2019-02-23
- `smartisan` 新增产品代号。
### 2019-02-21
- `mitv` 新增部分小米电视印度型号。
- `samsung` 新增 Galaxy S10 系列。
- `samsung` 去掉 Beta 标识。
### 2019-02-20
- `xiaomi` 新增小米 9、小米 9 SE。
### 2019-02-19
- `vivo` 新增 vivo Z3i 标准版、vivo Y93 标准版、vivo U1。
### 2019-02-12
- `honor` 新增部分产品代号。
- `huawei` 新增部分产品代号。
### 2019-02-07
...
- `honor` 新增荣耀 V20。
### 2018-12-24
- `xiaomi` 个别机型诸如红米 4 高配版（`B5W`, `markw`）、红米 Note 4（`B6L`, `nikel`）在内部代码（此处均指 MIUI 系统中的代码）中的代号为 `mark` / `nike`，后面多出来的字母出自 `B5W` / `B6L` 中的最后一个字母。部分机型如红米 1 系列、红米 2 系列等拥有多个内部代号（如红米 2A 高配版同时拥有 `wt86047`、`HM2014816`、`thomas` 三个代号），为避免可能的混淆，此汇总的产品机型代号将以 MIUI 官网可查到的代号（即线刷包中的代号）为准。
### 2018-12-21
- `xiaomi` 新增小米 Play。
### 2018-12-20
- `lenovo` 新增联想 S5 Pro GT。
- `letv` 初版。由于乐视已经不再推出新手机产品，该品牌汇总可能不再更新。
### 2018-12-18
- `lenovo` 新增联想 Z5s。
- `lenovo` 新增联想 Z5 Pro GT（855 版）。
### 2018-12-17
- `huawei` 新增 HUAWEI nova 4、华为畅享 9。
### 2018-12-11
- `vivo` 新增 vivo NEX 双屏版、vivo Y93s。
### 2018-12-10
- `samsung` 新增 Galaxy A8s。
### 2018-12-07
- `mitv` 新增小米电视印度尼西亚型号。
### 2018-12-03
- `huawei` 更正一处错误。
- `samsung` 初版（Beta 版）。
### 2018-11-28
- `360shouji` 对手机系列进行了分类。
- `honor` 新增荣耀 Waterplay 8 英寸 全网通版。
- `nubia` 对手机系列进行了分类。
- `xiaomi` 后缀为 H 的型号归入国际版（并非台湾独占）。
### 2018-11-26
- `oppo` 新增 OPPO A7。
### 2018-11-20
- `mitv` 新增小米电视 4S 75 英寸。
- `nokia` 新增诺基亚 3.1 Plus。
### 2018-11-16
- `vivo` 新增 vivo X23 幻彩版。
### 2018-11-15
- `nubia` 新增红魔 Mars 电竞手机。
### 2018-11-14
- `honor` 新增荣耀 10 青春版。
### 2018-11-13
- `vivo` 新增 vivo X21s。
