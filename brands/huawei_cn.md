...
**华为擎云 C5 (第 3 代) (`BartokR`):**

`BJS5-W00`: 华为擎云 C5 (第 3 代) 11.5 英寸 Wi-Fi 版

**华为擎云 C5 (第 4 代) (`Taoxingzhi`):**

`BYD5-W10` `BYS5-W10` `BJD5-W10`: 华为擎云 C5 (第 4 代) 11.5 英寸 Wi-Fi 版

`BYD5-AL10` `BYS-AL10` `BJD-AL10`: 华为擎云 C5 (第 4 代) 11.5 英寸 SIM 卡版
...
**华为擎云 C5e (第 2 代) (`Agassi6`):**

`BZF5-W00` `BZH5-W00`: 华为擎云 C5e (第 2 代) 11 英寸 Wi-Fi 版

**华为擎云 C5s (`Agassi6`):**

`BZF5-W00` `BZH5-W00`: 华为擎云 C5s 11 英寸 Wi-Fi 版

**华为擎云 C5x (`Agassi6`):**

`BLF5-W00`: 华为擎云 C5x 11 英寸 Wi-Fi 版
...
**华为擎云 C7 (第 3 代) (`Salinger`):**

`BBH7-W00`: 华为擎云 C7 (第 3 代) 11.5 英寸 Wi-Fi 版
...
**HUAWEI WATCH 5 / HUAWEI WATCH 十周年款:**
...
`CDY-B19`: 华为手环 11 标准版 (增强型聚合纤维表壳)

`CDY-B29`: 华为手环 11 标准版 (铝合金表壳)

`CDY-B39`: 华为手环 11 NFC 版
